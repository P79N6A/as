package com.yaoguang.shipper.my.setting.pushsetting;
...
public class PushSettingFragment extends BasePushSettingFragment {
    ...
    public boolean getPushType() {
        ...
        // 设置推送参数
        return userOwner.getMessageFlag() == 1;
    }

    @Override
    public void customCreateView() {
        //设置是否推送
        mViewHolder.sPush.setOnCheckedChangeListener((buttonView, isChecked) -> setPush(isChecked, Constants.APP_SHIPPER));
    }
