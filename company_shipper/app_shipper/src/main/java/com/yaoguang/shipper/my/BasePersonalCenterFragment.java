...
public abstract class BasePersonalCenterFragment<T> extends BaseFragment2 implements PersonalCenterContact.PersonalCenterView<T> {
    ...
    public void startCountDown() {
        mCountDownButtonHelper.init(btnGetCode, getString(com.yaoguang.appcommon.R.string.get_code), 90, 1);
    ...
    public class InitialView {
        ...
        public TextView tvAssociationManagementTitle;
        public RelativeLayout rlAssociationManagement;
        ...
        public View vAssociationManagement;
        ...
        private void initUI() {
            this.flMain = rootView.findViewById(R.id.flMain);
            this.textView = rootView.findViewById(R.id.textView);
            this.imgSetting = rootView.findViewById(R.id.imgSetting);
            this.ivAvatar = rootView.findViewById(R.id.ivAvatar);
            this.ivEditPhoto = rootView.findViewById(R.id.ivEditPhoto);
            this.tvName = rootView.findViewById(R.id.tvName);
            this.tvTel = rootView.findViewById(R.id.tvTel);
            ...
            this.tvAssociationManagementTitle = (TextView) rootView.findViewById(R.id.tvAssociationManagementTitle);
            this.rlAssociationManagement = (RelativeLayout) rootView.findViewById(R.id.rlAssociationManagement);
            ...
            this.vAssociationManagement = rootView.findViewById(R.id.vAssociationManagement);
