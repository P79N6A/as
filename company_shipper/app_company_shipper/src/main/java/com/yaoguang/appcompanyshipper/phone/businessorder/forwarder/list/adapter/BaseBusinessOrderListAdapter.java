package com.yaoguang.appcompanyshipper.phone.businessorder.forwarder.list.adapter;
...
public abstract class BaseBusinessOrderListAdapter<T> extends BaseLoadMoreRecyclerAdapter<T, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business_order, parent, false);
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvCarriageItem;
        public TableLayout tlWait;
        LikeButton lbtnStars;
        ...
        public ItemViewHolder(View rootView) {
            ...
            this.tvCarriageItem = (TextView) rootView.findViewById(R.id.tvCarriageItem);
