 ...
 */
public class BusinessOrderListPresenter extends BaseBusinessOrderTrailerListPresenter<AppCompanyOrderCondition, AppTruckOrder> {
    ...
    @Override
    protected Observable<BaseResponse<PageList<AppTruckOrder>>> initDatas(AppCompanyOrderCondition condition, int pageIndex) {
        return mTruckOrderDataSource.getAppOrders(condition, pageIndex);
    }


    @Override
    public void addTemplate(AppTruckOrder item) {
        mTruckOrderDataSource.addTemplate(item)
