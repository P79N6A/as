...
import com.yaoguang.company.my.loginconditionconfiguration.wifimanagement.list.adapter.WiFiManagementAdapter;
 ...
 */
public class WiFiManagementFragment extends BaseFragmentListConditionDataBind<UserLoginAllowWlan, String, WiFiManagementAdapter, FragmentWifiManagementBinding>
    ...
    public int getLayoutId() {
        return R.layout.fragment_wifi_management;
    }
    ...
    public void init() {
        if (mDataBinding.toolbarCommon != null) {
            initToolbarNav(mToolbarCommonBinding.toolbar, "WiFi网络群组管理", R.menu.menu_time_management, this);
        }
    }
