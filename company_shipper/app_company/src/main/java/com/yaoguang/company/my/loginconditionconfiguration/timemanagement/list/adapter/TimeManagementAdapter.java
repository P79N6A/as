package com.yaoguang.company.my.loginconditionconfiguration.timemanagement.list.adapter;
...
public class TimeManagementAdapter extends BaseLoadMoreRecyclerAdapter<UserLoginTime, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_time_management, parent, false);
