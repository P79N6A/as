...
public class MainActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<DPoint> points = getIntent().getParcelableArrayListExtra("points");
        mAMapGeoFence = new AMapGeoFence(this.getApplicationContext(), mAMap, handler,points);
    }
...
//                            Toast.LENGTH_SHORT).show();
                ...
                case 2:
                    ...
                    ((TextView) findViewById(R.id.message)).setText(((TextView) findViewById(R.id.message)).getText() + "  " + statusStr);
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null && amapLocation.getErrorCode() == 0) {
                ...
                if (!message.equals("Latitude" + amapLocation.getLatitude() + " " + "Longitude" + amapLocation.getLongitude() + " ")) {
                    message = "Latitude" + amapLocation.getLatitude() + " " + "Longitude" + amapLocation.getLongitude() + " ";
