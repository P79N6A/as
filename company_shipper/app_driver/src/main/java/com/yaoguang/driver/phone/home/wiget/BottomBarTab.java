...
//        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(size, size);
        ...
        paramsTv.bottomMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics());
        ...
        tvUnReadParams.leftMargin = dip2px(context, 13);
        tvUnReadParams.bottomMargin = dip2px(context, 18);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.orange500));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.orange500));
        } else {
