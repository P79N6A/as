package com.yaoguang.map.common.tts;
...
/**
 * Created by zhongjh on 2018/5/31.
 */

public class TTSController implements AMapNaviListener, TTSICallBack {
    ...
    public void onGetNavigationText(String playText) {
        if (wordList != null) {
            // 判断是否一样，如果一样，为了防止重复播放，就不添加了
            if (!wordList.contains(playText))
