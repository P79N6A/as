 ...
 */
public abstract class BaseSubmitProgressFragment extends BaseFragment {
     ...
     * 按钮延时1.5秒后执行动画
     */
    public abstract void submitProgressSuccess();
    ...
    static class MyHandler extends Handler {
        WeakReference<BaseSubmitProgressFragment> mBaseSubmitProgressFragment;

        MyHandler(BaseSubmitProgressFragment baseSubmitProgressFragment) {
            mBaseSubmitProgressFragment = new WeakReference<>(baseSubmitProgressFragment);
        }

        @Override
        public void handleMessage(Message msg) {
            BaseSubmitProgressFragment baseSubmitProgressFragment = mBaseSubmitProgressFragment.get();
            baseSubmitProgressFragment.submitProgressSuccess();
        }
    }
