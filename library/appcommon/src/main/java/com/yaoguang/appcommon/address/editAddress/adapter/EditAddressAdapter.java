package com.yaoguang.appcommon.address.editAddress.adapter;
 ...
 */
public class EditAddressAdapter extends BaseLoadMoreRecyclerAdapter<Tip, RecyclerView.ViewHolder> {
