package com.yaoguang.qrcodescan;
...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = getResources().getColor(R.color.primary);
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF, getResources().getColor(R.color.primary), 0x00FFFFFF};
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(
                text,
                (width - textWidth) / 2,
                (float) (frame.bottom + (float) 30 * density),
                paint);
