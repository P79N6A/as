...
public class FloatingSearchView extends FrameLayout {
    ...
    private Drawable mMenuBtnDrawable;
...
//        mMenuBtnDrawable = new DrawerArrowDrawable(getContext());
        mMenuBtnDrawable = Util.getWrappedDrawable(getContext(), R.drawable.ic_arrow_back_black_24dp);
    ...
    private void setupQueryBar() {
        ...
        mMenuView.setMenuCallback(new MenuBuilder.Callback() {
            ...
            public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
                ...
                // check if we should care about this return or not
                return false;
            }
