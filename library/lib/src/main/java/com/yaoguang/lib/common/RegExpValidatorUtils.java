...
/**
 * Created by zhongjh on 2017/2/18.
 * 验证工具类
 */
public class RegExpValidatorUtils {
    ...
    public static boolean isEmail(String str) {
        String regex = "^([\\w-\\.]+)@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.)|(([\\w-]+\\.)+))([shake_x-zA-Z]{2,4}|[0-9]{1,3})(\\]?)$";
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean IsPasswordLetter(String str) {
        String regex = "[A-Za-z]";
        return match(regex, str);
    }
    ...
    public static boolean IsPasswordNumber(String str) {
        String regex = "^(?![^shake_x-zA-Z]+$)(?!\\D+$).{8,15}$";
        return match(regex, str);
    }
     ...
     * 弱密码
     *
     * @return 密码(以字母开头，长度在6~18之间，只能包含字母、数字和下划线)
     */
...
// 加了时间验证的YYYY-MM-DD 00:00:00
    ...
    public static boolean isMobile(String mobile) {
        return !(TextUtils.isEmpty(mobile) || !mobile.startsWith("1") || mobile.length() != 11 || !RegExpValidatorUtils.IsNumber(mobile));
    }
