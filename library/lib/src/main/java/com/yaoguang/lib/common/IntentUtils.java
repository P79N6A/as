...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file, String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(BaseApplication.getInstance().getBaseContext(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return BaseApplication.getInstance().getBaseContext().getPackageManager().getLaunchIntentForPackage(packageName);
    }
