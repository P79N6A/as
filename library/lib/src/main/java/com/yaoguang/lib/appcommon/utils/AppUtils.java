...
import com.yaoguang.lib.common.CleanUtils;
import com.yaoguang.lib.common.EncryptUtils;
import com.yaoguang.lib.common.file.FileUtils;
import com.yaoguang.lib.common.IntentUtils;
import com.yaoguang.lib.common.ProcessUtils;
import com.yaoguang.lib.common.ShellUtils;
...
public final class AppUtils {
    ...
    public static void installApp(File file, String authority) {
        ...
        BaseApplication.getInstance().getBaseContext().startActivity(IntentUtils.getInstallAppIntent(file, authority));
    }
    ...
    public static void uninstallApp(String packageName) {
        ...
        BaseApplication.getInstance().getBaseContext().startActivity(IntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppRoot() {
        ...
        if (result.errorMsg != null) {
            XLog.d("isAppRoot", result.errorMsg);
        }
        return false;
    }
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.getInstance().getBaseContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.getInstance().getBaseContext().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static String getAppName(String packageName) {
        ...
        try {
            PackageManager pm = BaseApplication.getInstance().getBaseContext().getPackageManager();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) BaseApplication.getInstance().getBaseContext().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(BaseApplication.getInstance().getBaseContext().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseApplication.getInstance().getBaseContext().getPackageName());
    }
    ...
    public static String getHandSetInfo(){
        String handSetInfo=
                "手机型号:" + android.os.Build.MODEL +
                        ...
                        ",软件版本:"+ AppUtils.getAppPackageName();
        return handSetInfo;
