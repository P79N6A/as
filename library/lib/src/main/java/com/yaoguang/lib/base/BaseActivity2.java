 ...
 * 一个基类
 */
public abstract class BaseActivity2 extends SupportActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDataBind(getLayoutId());

        // 计算toolbar高度，倾入式后高度变化
        View titleBar = findViewById(R.id.toolbar);
        if (titleBar != null)
            ImmersionBar.setTitleBar(BaseActivity2.this, titleBar);
     ...
     * 加载数据绑定
     */
    public abstract void initDataBind(int layoutResID);
