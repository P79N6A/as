package com.yaoguang.lib.treerecyclerview.adpater;
...
import com.yaoguang.lib.treerecyclerview.base.BaseRecyclerAdapter;
import com.yaoguang.lib.treerecyclerview.base.ViewHolder;
import com.yaoguang.lib.treerecyclerview.factory.ItemHelperFactory;
import com.yaoguang.lib.treerecyclerview.item.TreeItem;
import com.yaoguang.lib.treerecyclerview.item.TreeItemGroup;
import com.yaoguang.lib.treerecyclerview.manager.ItemManager;
                ...
                public void onClick(View v) {
                    ...
                    if (getCheckItem().checkPosition(layoutPosition)) {
                        ...
                        if (type != TreeRecyclerType.SHOW_ALL && item instanceof TreeItemGroup) {
                            ...
                            //拿到对应item,回调.
                            getDatas().get(itemPosition).onClick(holder.itemView, getDatas(), itemPosition);
                        } else {
