...
import com.yaoguang.driver.my.modify.password.ModifyPass2Fragment;
...
public class ForgetPasswordStep2Activity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            loadRootFragment(R.id.fl_container, ModifyPass2Fragment.newInstanceActivity(getIntent().getStringExtra("mobile"), getIntent().getStringExtra("autoCode")));
        }
    }
