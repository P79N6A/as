...
import com.yaoguang.appcommon.my.feedback.DFeedbackPresenter;
import com.yaoguang.appcommon.my.feedback.FeedbackContacts;
...
import static com.yaoguang.greendao.entity.driver.FeedbackApp.FEEDBACK_TYPE_ADVICE;
import static com.yaoguang.greendao.entity.driver.FeedbackApp.FEEDBACK_TYPE_BUG;
import static com.yaoguang.greendao.entity.driver.FeedbackApp.FEEDBACK_TYPE_OTHER;
...
public abstract class BaseFeedbackFragment extends BaseNodeUploadFragment implements FeedbackContacts.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mDFeedbackPresenter = new DFeedbackPresenter(this);
    ...
    protected final class InitialView {
        ...
        private void initView(View view) {
            ...
            // 添加菜单
            toolbar.inflateMenu(R.menu.driver_submit);
            ...
            toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    if (TextUtils.isEmpty(feedbackString)) {
                        Toast.makeText(getContext(), "请输入不少于10个字的描述", Toast.LENGTH_SHORT).show();
                        return false;
                    }
                    ...
                    feedbackApp.setUserId(Injection.provideDriverRepository(BaseApplication.getInstance()).getDriver().getId());
