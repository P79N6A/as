...
import static com.yaoguang.common.common.DateUtils.dateToString;
...
public class DriverStatusSwitchAddFragment extends BaseNodeUploadFragment implements DStatusSwitchAddContact.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getContext(), R.layout.activity_driver_status_switch_add, null);
        mInitialView = new InitialView(view);
        presenter = new DStatusSwitchAddPresenter(this, Injection.provideDriverRepository(getContext()));
    ...
    public boolean onBackPressedSupport() {
        ...
        mDialogHelper.showConfirmDialog(getContext(), "提示", "确定放弃编辑", "是的","我再想想",false, new CommonDialog.Listener() {
            @Override
            public void ok() {
                mDialogHelper.hideDialog();
                pop();
